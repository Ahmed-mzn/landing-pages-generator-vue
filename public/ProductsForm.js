    ...
    <div>
      <section class="mt-4">
        <div class="container">
            ...
            <a @click="success = false" href="#order_now" class="btn btn-primary py-3" type="button" style="width: 100%;background: var(--bs-primary);border-style: none;border-radius: 4px;margin-top: 34px;">اطلبه الآن</a>
