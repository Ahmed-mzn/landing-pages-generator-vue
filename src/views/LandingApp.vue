    ...
    <template v-if="appActivated">
      ...
      <b-row align-v="stretch">
        <b-col cols="6" xl="3" lg="4" md="4" v-for="template in app.templates" :key="template.id">
          ...
          <b-card
            :header="template.template_code == 'template_one' ? 'صفحات الهبوط 1' : 'صفحات الهبوط 2'"
            header-tag="h6"
          >
            <b-img
              fluid
              class="mb-2"
              src="https://cdn.dribbble.com/users/1415337/screenshots/5460452/skeleton400_still.gif"
            />
            <b-card-text>
...
BAlert, BMedia, BMediaAside, BMediaBody, BInputGroup, BInputGroupPrepend, BOverlay } from 'bootstrap-vue'
